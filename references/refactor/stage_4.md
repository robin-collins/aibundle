## Stage 4: Extract Configuration Module

### Stage 4 Goal
Move configuration loading and saving code to a dedicated module.

### Stage 4 Steps

1. Create `src/config/mod.rs` for configuration-related functions:
