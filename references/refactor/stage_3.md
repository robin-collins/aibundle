## Stage 3: Extract CLI Module

### Stage 3 Goal
Move all CLI-related code to the CLI module.

### Stage 3 Steps

1. Create `src/cli/mod.rs` to export the CLI module's public interface:
...
2. Create `src/cli/options.rs` and move all CLI option structs and related functions:
